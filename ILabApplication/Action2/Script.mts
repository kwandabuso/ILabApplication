...
Browser("Home Page | iLAB").Page("CAREERS | iLAB").Link("South Africa").Click @@ hightlight id_;_Browser("Home Page | iLAB").Page("CAREERS | iLAB").Link("South Africa")_;_script infofile_;_ZIP::ssf2.xml_;_
 @@ hightlight id_;_Browser("Home Page | iLAB").Page("SOUTH AFRICA | iLAB").Link("Interns - BSC Computer")_;_script infofile_;_ZIP::ssf3.xml_;_
...
Browser("Home Page | iLAB").Page("Interns - BSC Computer").WebEdit("applicant_name").Set DataTable("Name", dtGlobalSheet) @@ hightlight id_;_Browser("Home Page | iLAB").Page("Interns - BSC Computer").WebEdit("applicant name")_;_script infofile_;_ZIP::ssf5.xml_;_
Browser("Home Page | iLAB").Page("Interns - BSC Computer").WebEdit("email").Set DataTable("Email", dtGlobalSheet) @@ hightlight id_;_Browser("Home Page | iLAB").Page("Interns - BSC Computer").WebEdit("email")_;_script infofile_;_ZIP::ssf6.xml_;_
Browser("Home Page | iLAB").Page("Interns - BSC Computer").WebEdit("phone").Set DataTable("PhoneNumber", dtGlobalSheet) @@ hightlight id_;_Browser("Home Page | iLAB").Page("Interns - BSC Computer").WebEdit("phone")_;_script infofile_;_ZIP::ssf7.xml_;_
Browser("Home Page | iLAB").Page("Interns - BSC Computer").WebEdit("message").Set DataTable("Message", dtGlobalSheet) @@ hightlight id_;_Browser("Home Page | iLAB").Page("Interns - BSC Computer").WebEdit("message")_;_script infofile_;_ZIP::ssf8.xml_;_
